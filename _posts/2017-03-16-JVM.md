...
+ -Xms heap的初始大小
+ -Xmx Heap的最大阈值<br>
>在注重延时或者吞吐量时，一般将-Xms与-Xmn设为一样<br>
+ 新生代参数<br>
